...
The last 2 are not very popular.
...
- [RTSPMultiCam](https://github.com/jiaxin-du/RTSPMultiCam) - not suitable.
...
Unload the recorded videos and run the [script](TODO) to take out the frames. This script takes frames exponentially. Then we process the images and make graphs.
### Error calculation
